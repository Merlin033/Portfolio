...
const Home = () => {
  return (
    <section id="home" className='relative flex flex-col min-h-[90vh] bg-black justify-center items-center z-[1]'>
      <div className='relative flex-col w-full h-full bg-opacity-10 bg-white flex'>
        <h1 className='sm:py-64 py-12 font-montserrat text-secondary text-8xl self-center'>Barnabe Debocq</h1>
