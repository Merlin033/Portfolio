...
export const metadata = {
  title: 'Barnabe DEBOCQ | Portfolio - développeur web front-end',
  description: 'Je suis Barnabe DEBOCQ, développeur web front-end freelance passionné par la création web. Expertise en HTML, CSS, Javascript, React et responsive design.',
  themeColor: 'black',
  icons: {
