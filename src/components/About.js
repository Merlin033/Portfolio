        ...
        <div className="content-about">
          ...
          >
            <p className='pt-3 text-sm lg:text-[1.2rem] text-gray-light leading-6'>
              Je suis principalement concentré sur le développement front-end,
              où j&apos;adore concevoir des interfaces utilisateurs intuitives et
              esthétiques. J&apos;ai débuté mon parcours de développeur web en
              autodidacte et exploré la création de sites via projets et cours
              en ligne.
            </p>
            <p className='pt-3 text-sm lg:text-[1.2rem] text-gray-light leading-6'>
              Formé intensivement pendant 9 mois chez OpenCLassrooms, j&apos;ai pu me familiariser,
              ...
              applications web performantes. Je reste toujours motivé à
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <a href="#contact" className='inline-block mt-9 uppercase font-medium pl-[2px] text-[1.5rem] leading-[0.875rem] tracking-widest shadow-[inset_0px_-6px_0px] shadow-pink-light transition-all duration-[400ms] ease-out hover:shadow-[inset_0px_-15px_0px] hover:shadow-pink-light '>Me contacter</a>
          </motion.div>
